...
import pytest
import redis5.sentinel
from redis5 import exceptions
from redis5.sentinel import (
    MasterNotFoundError,
    Sentinel,
...
class SentinelTestClient:
    ...
    def execute_command(self, *args, **kwargs):
        ...
        from redis5.client import bool_ok
...
def cluster(request, master_ip):
    def teardown():
        redis5.sentinel.Redis = saved_Redis

    cluster = SentinelTestCluster(ip=master_ip)
    saved_Redis = redis5.sentinel.Redis
    redis5.sentinel.Redis = cluster.client
