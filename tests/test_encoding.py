import pytest
import redis5
from redis5.connection import Connection
from redis5.utils import HIREDIS_PACK_AVAILABLE
...
class TestEncoding:
    ...
    def r_no_decode(self, request):
        return _get_client(redis5.Redis, request=request, decode_responses=False)
...
class TestCommandsAreNotEncoded:
    @pytest.fixture()
    def r(self, request):
        return _get_client(redis5.Redis, request=request, encoding="utf-8")
