...
lib = "mylib"
lib2 = "mylib2"
function = "redis5.register_function{function_name='myfunc', callback=function(keys, \
            args) return args[1] end, flags={ 'no-writes' }}"
function2 = "redis5.register_function('hello', function() return 'Hello World' end)"
set_function = "redis5.register_function('set', function(keys, args) return \
                redis5.call('SET', keys[1], args[1]) end)"
get_function = "redis5.register_function('get', function(keys, args) return \
                redis5.call('GET', keys[1]) end)"
