...
import pytest
import redis5
from redis5 import AuthenticationError, DataError, ResponseError
...
class TestCredentialsProvider:
    ...
    def test_only_pass_without_creds_provider(self, r, request):
        ...
        r2 = _get_client(redis5.Redis, request, flushdb=False, password=password)
    ...
    def test_user_and_pass_without_creds_provider(self, r, request):
        ...
        r2 = _get_client(
            redis5.Redis, request, flushdb=False, username=username, password=password
        )
    ...
    def test_credential_provider_with_supplier(self, r, request, username):
        ...
        r2 = _get_client(
            redis5.Redis, request, flushdb=False, credential_provider=creds_provider
        )
...
class TestUsernamePasswordCredentialProvider:
    def test_user_pass_credential_provider_acl_user_and_pass(self, r, request):
        ...
        r2 = _get_client(
            redis5.Redis, request, flushdb=False, credential_provider=provider
        )
        assert r2.ping() is True
