...
import pytest
import redis5
from redis5._parsers import _HiredisParser, _RESP2Parser, _RESP3Parser
from redis5.backoff import NoBackoff
from redis5.connection import Connection, SSLConnection, UnixDomainSocketConnection
...
def test_connection_parse_response_resume(r: redis5.Redis, parser_class):
    """
...
def test_create_single_connection_client_from_url():
    client = redis5.Redis.from_url(
        "redis5://localhost:6379/0?", single_connection_client=True
    )
