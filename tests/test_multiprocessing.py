...
import pytest
import redis5
from redis5.connection import Connection, ConnectionPool
...
class TestMultiprocessing:
    ...
    @pytest.fixture()
    def r(self, request):
        return _get_client(redis5.Redis, request=request, single_connection_client=False)
    ...
    def test_pool(self, max_connections, master_host):
        ...
        pool = ConnectionPool.from_url(
            f"redis5://{master_host[0]}:{master_host[1]}",
    ...
    def test_redis_client(self, r):
        "A redis5 client created in a parent can also be used in a child"
