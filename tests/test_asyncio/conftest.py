...
from redis5._parsers import _AsyncHiredisParser, _AsyncRESP2Parser
from redis5.asyncio.client import Monitor
from redis5.asyncio.connection import parse_url
...
async def create_redis(request):
    """Wrapper around redis5.create_redis."""
...
def redis_url(request):
    return request.config.getoption("--redis5-url")
