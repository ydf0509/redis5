...
class TestBaseException:
    ...
    async def test_base_exception(self, r: redis.Redis):
        ...
        # timeout waiting for another message which never arrives
        assert pubsub.connection.is_connected
        with patch("redis5._parsers._AsyncRESP2Parser.read_response") as mock1, patch(
            "redis5._parsers._AsyncHiredisParser.read_response"
        ) as mock2, patch("redis5._parsers._AsyncRESP3Parser.read_response") as mock3:
