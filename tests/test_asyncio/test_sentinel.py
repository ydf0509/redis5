...
import redis5.asyncio.sentinel
...
class SentinelTestClient:
    ...
    async def execute_command(self, *args, **kwargs):
        ...
        from redis5.asyncio.client import bool_ok
...
async def cluster(master_ip):
    ...
    saved_Redis = redis5.asyncio.sentinel.Redis
    redis5.asyncio.sentinel.Redis = cluster.client
    yield cluster
    redis5.asyncio.sentinel.Redis = saved_Redis
