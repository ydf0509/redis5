...
from redis5.exceptions import LockError, LockNotOwnedError

if TYPE_CHECKING:
    from redis5.asyncio import Redis, RedisCluster
...
class Lock:
    ...
    LUA_RELEASE_SCRIPT = """
        local token = redis5.call('get', KEYS[1])
        if not token or token ~= ARGV[1] then
            return 0
        end
        redis5.call('del', KEYS[1])
        return 1
    """
    ...
    LUA_EXTEND_SCRIPT = """
        ...
        local expiration = redis5.call('pttl', KEYS[1])
        ...
        redis5.call('pexpire', KEYS[1], newttl)
        return 1
    """
    ...
    LUA_REACQUIRE_SCRIPT = """
        ...
        redis5.call('pexpire', KEYS[1], ARGV[2])
        return 1
    """
