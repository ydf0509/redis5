...
from redis5.compat import Protocol, TypedDict
from redis5.connection import DEFAULT_RESP_VERSION
from redis5.credentials import CredentialProvider, UsernamePasswordCredentialProvider
...
from redis5.typing import EncodableT
from redis5.utils import HIREDIS_AVAILABLE, get_lib_version, str_if_bytes
...
def parse_url(url: str) -> ConnectKwargs:
    ...
    if parsed.scheme == "unix":
    ...
    elif parsed.scheme in ("redis5", "rediss"):
        if parsed.hostname:
        ...
        valid_schemes = "redis5://, rediss://, unix://"
        raise ValueError(
...
class BlockingConnectionPool(ConnectionPool):
    ...
    Thread-safe blocking connection pool::
        ...
        >>> from redis5.client import Redis
