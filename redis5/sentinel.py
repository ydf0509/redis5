...
from redis5.commands import SentinelCommands
from redis5.connection import Connection, ConnectionPool, SSLConnection
from redis5.exceptions import ConnectionError, ReadOnlyError, ResponseError, TimeoutError
...
class Sentinel(SentinelCommands):
    ...
    >>> from redis5.sentinel import Sentinel
