import redis5
from redis5._parsers.helpers import bool_ok
...
class TimeSeries(TimeSeriesCommands):
    ...
    def pipeline(self, transaction=True, shard_hint=None):
        ...
        """
        if isinstance(self.client, redis5.RedisCluster):
            p = ClusterPipeline(
...
class ClusterPipeline(TimeSeriesCommands, redis5.cluster.ClusterPipeline):
    """Cluster pipeline for the module."""


class Pipeline(TimeSeriesCommands, redis5.client.Pipeline):
