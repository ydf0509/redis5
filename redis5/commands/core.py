...
from redis5.compat import Literal
from redis5.exceptions import ConnectionError, DataError, NoScriptError, RedisError
from redis5.typing import (
    AbsExpiryT,
    AnyKeyT,
    BitfieldOffsetT,
    ChannelT,
...
if TYPE_CHECKING:
    from redis5.asyncio.client import Redis as AsyncRedis
...
class ManagementCommands(CommandsProtocol):
    ...
    def sync(self) -> ResponseT:
        ...
        """
        from redis5.client import NEVER_DECODE
...
class BasicKeyCommands(CommandsProtocol):
    ...
    def mget(self, keys: KeysT, *args: EncodableT) -> ResponseT:
        ...
        """
        from redis5.client import EMPTY_RESPONSE
...
class Script:
    ...
    def __call__(
        ...
        from redis5.client import Pipeline
...
class AsyncScript:
    ...
    async def __call__(
        ...
        args = tuple(keys) + tuple(args)
        # make sure the Redis server knows about the script
        from redis5.asyncio.client import Pipeline
...
class Script:
    ...
    def get_encoder(self):
        ...
        try:
            ...
            # redis5. ClusteredRedis doesn't have a `.connection_pool` attribute
