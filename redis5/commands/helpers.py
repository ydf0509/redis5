...
import redis5
from redis5.typing import KeysT, KeyT
...
def get_protocol_version(client):
    if isinstance(client, redis5.Redis) or isinstance(client, redis5.asyncio.Redis):
        return client.connection_pool.connection_kwargs.get("protocol")
    elif isinstance(client, redis5.cluster.AbstractRedisCluster):
