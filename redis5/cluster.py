...
from redis5._parsers import CommandsParser, Encoder
from redis5._parsers.helpers import parse_scan
from redis5.backoff import default_backoff
from redis5.client import CaseInsensitiveDict, PubSub, Redis
from redis5.commands import READ_COMMANDS, RedisClusterCommands
from redis5.commands.helpers import list_or_args
from redis5.connection import ConnectionPool, DefaultParser, parse_url
...
from redis5.lock import Lock
from redis5.retry import Retry
from redis5.utils import (
    HIREDIS_AVAILABLE,
    dict_merge,
    list_keys_to_dict,
    merge_result,
...
def block_pipeline_command(name: str) -> Callable[..., Any]:
    ...
    def inner(*args, **kwargs):
        raise RedisClusterException(
            ...
            f"when running redis5 in cluster mode..."
        )
