...
from redis5.compat import Protocol

if TYPE_CHECKING:
    from redis5._parsers import Encoder
    from redis5.asyncio.connection import ConnectionPool as AsyncConnectionPool
    from redis5.connection import ConnectionPool
...
KeyT = _StringLikeT  # Main redis5 key space
